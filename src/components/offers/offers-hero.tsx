    ...
    >
      ...
      <div className="relative container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            {[
              { icon: Tag, value: "500+", label: "Ofertas Activas" },
              { icon: TrendingDown, value: "70%", label: "Descuento Máximo" },
              { icon: Clock, value: "24h", label: "Ofertas Flash" },
              { icon: Zap, value: "Nuevo", label: "Cada Día" },
