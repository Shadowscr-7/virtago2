...
const mockOffers: Offer[] = [
  {
    ...
    description: "El iPhone más avanzado con chip A17 Pro y cámara de 48MP. Perfecto para profesionales que buscan la máxima calidad.",
    minQuantity: 1,
    maxQuantity: 5,
    savedAmount: 400
  },
  {
    ...
    description: "Smartphone con S Pen integrado y cámara de 200MP. Ideal para productividad y fotografía profesional.",
    minQuantity: 1,
    maxQuantity: 3,
    savedAmount: 400
  },
  {
    ...
    description: "Laptop profesional con chip M3 Pro. Rendimiento excepcional para desarrollo, diseño y edición de video.",
    minQuantity: 1,
    maxQuantity: 2,
    savedAmount: 400
  },
  {
    ...
    description: "Auriculares premium con la mejor cancelación de ruido del mercado. Batería de 30 horas.",
    minQuantity: 2,
    maxQuantity: 10,
    savedAmount: 120
  },
  {
    ...
    description: "Zapatillas icónicas en edición retro. Diseño clásico con comodidad moderna.",
    minQuantity: 1,
    maxQuantity: 3,
    savedAmount: 51
  },
  {
    ...
    description: "Set anti-edad completo con ácido hialurónico y pro-retinol. Resultados visibles en 4 semanas.",
    minQuantity: 1,
    maxQuantity: 5,
    savedAmount: 30
  },
  {
    ...
    description: "Set de llantas originales BMW en aleación ligera. Incluye sensores de presión.",
    minQuantity: 1,
    maxQuantity: 2,
    savedAmount: 301
  },
  {
    ...
    description: "Escritorio ergonómico con gestión de cables y superficie resistente a manchas. Ideal para gaming y trabajo.",
    minQuantity: 1,
    maxQuantity: 3,
    savedAmount: 100
  },
  {
    ...
    isFeatured: true,
    offerType: "Flash Sale",
    description: "Tablet 2-en-1 con procesador Intel i7. Incluye teclado Type Cover y Surface Pen.",
    minQuantity: 1,
    maxQuantity: 2,
    savedAmount: 300
  },
  {
    ...
    isFeatured: false,
    offerType: "Descuento por Volumen",
    description: "Aspiradora premium con detección láser de polvo y batería de hasta 60 minutos.",
    minQuantity: 1,
    maxQuantity: 3,
    savedAmount: 200
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1581244277943-fe4a9c777189?w=500&h=500&fit=crop",
    rating: 4.7,
    reviews: 2134,
    stockLeft: 35,
    ...
    isFeatured: false,
    offerType: "Oferta del Día",
    description: "Kit profesional con taladro, baterías, cargador y maletín. Ideal para construcción y bricolaje.",
    minQuantity: 1,
    maxQuantity: 5,
    savedAmount: 50
  },
  {
    ...
    isFeatured: false,
    offerType: "Descuento por Volumen",
    description: "Pack profesional de café premium. Variedad de intensidades para oficinas y restaurantes.",
    minQuantity: 5,
    maxQuantity: 20,
    savedAmount: 25
  }
...
export function OffersSection() {
  ...
  const filteredOffers = useMemo(() => {
    ...
    if (filters.timeLeft.length > 0) {
      filtered = filtered.filter(offer => {
        const totalMinutes = offer.timeLeft.days * 24 * 60 + offer.timeLeft.hours * 60 + offer.timeLeft.minutes
        return filters.timeLeft.some(timeRange => {
          if (timeRange === 'Menos de 1 hora') return totalMinutes < 60
          if (timeRange === '1-6 horas') return totalMinutes >= 60 && totalMinutes < 360
          if (timeRange === '6-24 horas') return totalMinutes >= 360 && totalMinutes < 1440
          if (timeRange === '1-3 días') return totalMinutes >= 1440 && totalMinutes < 4320
          if (timeRange === '3-7 días') return totalMinutes >= 4320 && totalMinutes < 10080
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            ...
            {filters.search || filters.category.length > 0 || filters.discountRange.length > 0 || filters.timeLeft.length > 0 || filters.offerType.length > 0 ? (
              <button
