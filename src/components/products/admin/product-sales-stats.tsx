...
import { TrendingUp, Star, DollarSign, Package, Calendar, RotateCcw, Target } from "lucide-react"
...
export function ProductSalesStats({
  productData
}: ProductSalesStatsProps) {
  ...
  const getColorClasses = (color: string) => {
    const colors = {
      purple: "from-purple-500/20 to-pink-500/20 border-purple-500/30 text-purple-700 dark:text-purple-300",
      green: "from-green-500/20 to-emerald-500/20 border-green-500/30 text-green-700 dark:text-green-300",
      yellow: "from-yellow-500/20 to-orange-500/20 border-yellow-500/30 text-yellow-700 dark:text-yellow-300",
      ...
      indigo: "from-indigo-500/20 to-purple-500/20 border-indigo-500/30 text-indigo-700 dark:text-indigo-300"
    }
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50/50 dark:bg-slate-700/30 rounded-xl border border-white/20">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`text-sm font-medium ${
                salesStats.salesTrend === 'up' ? 'text-green-600' : 'text-red-600'
              }`}>
