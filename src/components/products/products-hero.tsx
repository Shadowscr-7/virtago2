      ...
      <div className="relative container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            ...
            <span className="text-sm font-medium">Catálogo Premium B2B</span>
          </motion.div>
          ...
          >
            Descubre nuestra amplia selección de productos premium para empresas. 
            <span className="block mt-2 text-lg text-blue-200">
              Tecnología, innovación y calidad al mejor precio mayorista.
            </span>
          </motion.p>
          ...
          >
            ...
            <div className="text-center">
              ...
              <div className="text-blue-200 text-sm">Marcas Premium</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl mx-auto mb-2">
