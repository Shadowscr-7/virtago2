...
export function ProductsFilters({
  ...
  const getSubcategories = () => {
    ...
    const categoryKey = filterData.categories.find(
                    ...
                    <div className="space-y-2">
                      ...
                      {filteredCategories.length > ITEMS_LIMIT && (
                        ...
                        >
                          {showAllCategories
                            ? "Ver menos"
                            : `Ver ${filteredCategories.length - ITEMS_LIMIT} más`}
                        </button>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      {filteredBrands.length > ITEMS_LIMIT && (
                        ...
                        >
                          {showAllBrands
                            ? "Ver menos"
                            : `Ver ${filteredBrands.length - ITEMS_LIMIT} más`}
                        </button>
                      )}
                    </div>
                  </motion.div>
                    ...
                    <div className="space-y-2">
                      {getDisplayedItems(
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              updateFilter("supplier", supplier.id)
                            }
                            className="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500"
                          />
                          <span className="text-slate-700 dark:text-slate-300">
                      ...
                      {filteredSuppliers.length > ITEMS_LIMIT && (
                        ...
                        >
                          {showAllSuppliers
                            ? "Ver menos"
                            : `Ver ${filteredSuppliers.length - ITEMS_LIMIT} más`}
                        </button>
                      )}
                    </div>
                  </motion.div>
                      ...
                      {filterData.priceRanges.map((range) => (
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              updateFilter("priceRange", range.id)
                            }
                            className="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500"
                          />
                          <span className="text-slate-700 dark:text-slate-300">
                  ...
                  >
                    ...
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 cursor-pointer transition-colors">
                      <input
                        ...
                        onChange={(e) =>
                          updateFilter("onSaleOnly", e.target.checked)
                        }
                        className="w-4 h-4 text-blue-600 border-slate-300 rounded focus:ring-blue-500"
                      />
                      <span className="text-slate-700 dark:text-slate-300">
...
if (
  ...
  !document.getElementById("slider-styles")
) {
