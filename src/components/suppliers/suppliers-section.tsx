...
const mockSuppliers = [
  {
    ...
    description:
      "Proveedor líder en soluciones tecnológicas empresariales con más de 15 años de experiencia en el mercado B2B. Especialistas en infraestructura IT y transformación digital.",
  ...
  },
  {
    ...
    description:
      "Fabricante industrial especializado en maquinaria pesada y equipos de producción. Más de 20 años sirviendo a la industria manufacturera en toda Latinoamérica.",
  ...
  },
  {
    ...
    description:
      "Red logística integral con presencia en toda América Latina. Especialistas en cadena de suministro, almacenamiento y distribución para empresas B2B.",
  ...
  },
  {
    ...
    description:
      "Proveedor especializado en materiales de construcción de alta calidad. Amplio inventario y capacidad de suministro para proyectos de gran escala.",
  ...
  },
  {
    ...
    description:
      "Distribuidor autorizado de equipos médicos de última generación. Especialistas en tecnología sanitaria para hospitales y clínicas privadas.",
  ...
  },
  {
    ...
    description:
      "Fabricante y distribuidor de productos químicos industriales. Más de 25 años proporcionando soluciones químicas seguras y eficientes.",
  ...
  },
  {
    ...
    description:
      "Grupo de servicios financieros especializados en soluciones B2B. Financiamiento, seguros comerciales y servicios de tesorería corporativa.",
  ...
  },
  {
    ...
    description:
      "Agencia de marketing digital especializada en estrategias B2B. Generación de leads, automatización y analítica avanzada para empresas.",
    ...
    return suppliers.filter((supplier) => {
      ...
      if (filters.location.length > 0) {
        const supplierLocation =
          supplier.location.split(", ")[1] || supplier.location;
        if (
          !filters.location.some((loc: string) =>
            supplierLocation.includes(loc),
          )
        ) {
          return false;
        }
      ...
      if (
        ...
        !filters.companySize.includes(supplier.employees)
      ) {
        return false;
      }
      ...
      if (filters.certifications.length > 0) {
        const hasRequiredCert = filters.certifications.some((cert: string) =>
          supplier.certifications.some((supplierCert: string) =>
      ...
      if (filters.partnershipLevel.length > 0) {
        ...
        const hasRequiredLevel = filters.partnershipLevel.some(
          (level: string) => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Suppliers Grid */}
        <SuppliersGrid suppliers={filteredSuppliers} loading={isLoading} />
      </div>
    </div>
  );
}
