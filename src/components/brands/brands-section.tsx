...
const mockBrands = [
  {
    ...
    logo: "AP",
    description:
      "Líder mundial en tecnología de consumo, conocida por sus productos innovadores como iPhone, iPad, Mac y servicios digitales premium.",
    category: "Tecnología",
  ...
  },
  {
    ...
    logo: "SA",
    description:
      "Conglomerado tecnológico surcoreano líder en electrónicos de consumo, semiconductores y displays para el mercado global.",
  ...
  },
  {
    ...
    logo: "MS",
    description:
      "Gigante del software y servicios en la nube, creador de Windows, Office y Azure, líder en productividad empresarial.",
    category: "Tecnología",
    origin: "Estados Unidos",
    founded: 1975,
    rating: 4.7,
  ...
  },
  {
    ...
    logo: "SO",
    description:
      "Corporación japonesa pionera en entretenimiento y electrónicos, famosa por PlayStation, cámaras y audio de alta calidad.",
    category: "Electrónicos",
    origin: "Japón",
    founded: 1946,
    rating: 4.5,
  ...
  },
  {
    ...
    logo: "NK",
    description:
      "Marca global líder en calzado deportivo, ropa atlética e innovación en performance, inspirando a atletas de todo el mundo.",
  ...
  },
  {
    ...
    logo: "BM",
    description:
      "Fabricante alemán de automóviles de lujo y motocicletas, reconocido por su ingeniería de precisión y diseño innovador.",
    category: "Automotriz",
    origin: "Alemania",
    founded: 1916,
    rating: 4.6,
  ...
  },
  {
    ...
    logo: "IK",
    description:
      "Retailer sueco de muebles y artículos para el hogar, conocido por su diseño funcional, calidad y precios accesibles.",
  ...
  },
  {
    ...
    logo: "LO",
    description:
      "Líder mundial en cosméticos y belleza, ofreciendo productos innovadores para el cuidado personal y profesional.",
    ...
    return brands.filter((brand) => {
      ...
      if (filters.search) {
        ...
        const matchesSearch =
          ...
          brand.specialties.some((specialty: string) =>
      ...
      if (
        ...
        !filters.category.includes(brand.category)
      ) {
        return false;
      }
      ...
      if (filters.certification.length > 0) {
        const hasRequiredCert = filters.certification.some((cert: string) =>
          brand.certifications.some((brandCert: string) =>
            brandCert.includes(cert),
          ),
        );
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Filters */}
        <div className="mb-8">
          <BrandsFilters filters={filters} onFiltersChange={setFilters} />
        </div>
        ...
        {/* Brands Grid */}
        <BrandsGrid brands={filteredBrands} loading={isLoading} />
      </div>
    </div>
  );
}
