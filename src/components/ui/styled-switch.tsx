...
export function StyledSwitch({ 
  ...
  const colorClasses = {
    purple: { 
      active: "bg-gradient-to-r from-purple-500 to-violet-600 shadow-lg shadow-purple-500/25",
      focus: "focus:ring-purple-500/50",
      glow: "shadow-purple-400/30"
    },
    blue: { 
      active: "bg-gradient-to-r from-blue-500 to-cyan-600 shadow-lg shadow-blue-500/25",
      focus: "focus:ring-blue-500/50",
      glow: "shadow-blue-400/30"
    },
    green: { 
      active: "bg-gradient-to-r from-emerald-500 to-green-600 shadow-lg shadow-emerald-500/25",
      focus: "focus:ring-emerald-500/50",
      glow: "shadow-emerald-400/30"
    },
    orange: { 
      active: "bg-gradient-to-r from-orange-500 to-amber-600 shadow-lg shadow-orange-500/25",
      focus: "focus:ring-orange-500/50",
      glow: "shadow-orange-400/30"
    },
    red: { 
      active: "bg-gradient-to-r from-red-500 to-rose-600 shadow-lg shadow-red-500/25",
  ...
  return (
    <div className={`flex items-center ${label || description ? 'justify-between' : ''} ${disabled ? 'opacity-50' : ''} ${className}`}>
      {(label || description) && (
