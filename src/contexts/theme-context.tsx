...
export const themes: Record<ThemeVariant, ThemeColors> = {
  original: {
    ...
    glass: {
      primary: 'from-white/80 to-gray-50/80 dark:from-slate-800/80 dark:to-slate-700/80',
      secondary: 'from-white/70 to-gray-50/70 dark:from-slate-800/70 dark:to-slate-700/70',
    },
  },
  ocean: {
    name: 'Ocean Depths',
    ...
    glass: {
      primary: 'from-blue-50/80 to-cyan-50/80 dark:from-blue-900/80 dark:to-cyan-900/80',
      secondary: 'from-blue-50/70 to-cyan-50/70 dark:from-blue-900/70 dark:to-cyan-900/70',
    },
  },
  forest: {
    name: 'Forest Depths',
    ...
    glass: {
      primary: 'from-emerald-50/80 to-green-50/80 dark:from-emerald-900/80 dark:to-green-900/80',
      secondary: 'from-emerald-50/70 to-green-50/70 dark:from-emerald-900/70 dark:to-green-900/70',
    },
  },
  crimson: {
    name: 'Crimson Nights',
    ...
    glass: {
      primary: 'from-red-50/80 to-rose-50/80 dark:from-red-900/80 dark:to-rose-900/80',
      secondary: 'from-red-50/70 to-rose-50/70 dark:from-red-900/70 dark:to-rose-900/70',
    },
  },
};
