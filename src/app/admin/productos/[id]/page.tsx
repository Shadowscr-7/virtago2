...
const mockProductData = {
  ...
  sku: "SKU-31118",
  description: "El iPhone más avanzado hasta la fecha con chip A17 Pro, cámara profesional y diseño premium en titanio.",
  ...
  metaDescription: "Descubre el iPhone 15 Pro Max con chip A17 Pro, cámara profesional de 48MP y diseño en titanio. 256GB de almacenamiento.",
...
export default function ProductDetailPage() {
  ...
  const [originalData, setOriginalData] = useState<ProductData>(mockProductData)
