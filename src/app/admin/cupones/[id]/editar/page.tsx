...
export default function EditCouponPage() {
  ...
  useEffect(() => {
    const loadCoupon = async () => {
      ...
      reset({
        ...
        status:
          mockCouponData.status === "EXPIRED" ||
          mockCouponData.status === "USED_UP"
            ? "INACTIVE"
            : mockCouponData.status,
  ...
  const onSubmit = async (data: CouponForm) => {
    ...
    try {
      ...
      console.log("Datos del cupón editado:", {
        ...data,
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border bg-gray-50 transition-all focus:outline-none focus:ring-2 focus:ring-red-700/20 focus:border-red-700"
                    style={{
                      borderColor: errors.minOrderAmount ? "#ef4444" : "#e5e7eb",
                      color: themeColors.text.primary,
                    }}
                    placeholder="0"
                  />
          ...
          <div className="space-y-6">
            ...
            >
              <motion.button
                ...
                className="w-full px-6 py-3 rounded-xl font-semibold transition-all flex items-center justify-center gap-3 text-white bg-red-700 hover:bg-red-800 disabled:opacity-60"
              >
                {saving ? (
                  <>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full px-6 py-3 rounded-xl font-semibold transition-all flex items-center justify-center gap-3 border border-gray-200 bg-white hover:bg-gray-50"
                style={{ color: themeColors.text.primary }}
              >
                <X className="w-5 h-5" />
                Cancelar
